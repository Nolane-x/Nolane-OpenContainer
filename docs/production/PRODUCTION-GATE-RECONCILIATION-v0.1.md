...
- Gates: **304**
- Domains: **19**
- Seed-reconciled against implementation evidence: **40**
...
| P3 VFS, OPFS, persistence & data safety | 8 | 12 | 20 |
...
| P15 SDK, API, documentation & developer experience | 2 | 12 | 14 |
...
- Public S7 SDK does not yet expose the master-spec snapshot/restore/streaming export/import contract; current authority is internal/prototype-level.
