...
1. Remaining guest-isolation hardening beyond the promoted capability membrane, destructive CPU deadline, Worker quota and split CSP profiles: stronger origin separation, memory/side-channel abuse controls, and broader Node 24 compatibility.
