...
const required=[
  ...
  'packages/package-env/src/index.js','packages/network/src/index.js','packages/preview/src/index.js','packages/persistence/src/index.js',
  ...
  'tests/runtime.test.js','apps/playground/server.mjs'
];
