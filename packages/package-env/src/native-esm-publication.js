...
export class NativeEsmPublicationAuthority {
  ...
  async #serveFile(publication) {
    ...
    if (/\bcreateRequire\b/.test(source)) {
      const requireSpecifiers = staticCreateRequireSpecifiers(source);
  ...
  #serveCommonJs(publication, source) {
    ...
    const generated = [
      ...
      'function __oc_unwrap(ns){if(Object.prototype.hasOwnProperty.call(ns,"__opencontainer_cjs_cell")){const cell=ns.__opencontainer_cjs_cell;return Object.prototype.hasOwnProperty.call(cell,"current")?cell.current:cell;}if(Object.prototype.hasOwnProperty.call(ns,"__opencontainer_cjs_exports"))return ns.__opencontainer_cjs_exports;return ns;}',
      ...
      'export function __opencontainer_cjs_cell(){}',
      'const module={id:' + filename + ',filename:' + filename + ',exports:__opencontainer_cjs_cell,loaded:false,parent:null,children:[]};',
      ...
      '__opencontainer_cjs_cell.current=module.exports;',
