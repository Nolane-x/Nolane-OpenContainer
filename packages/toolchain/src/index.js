...
export const FrozenToolchains=Object.freeze({
  vite830:Object.freeze({
    ...
    lightningcssWasmSha256:'479c64bb651164b6fd9a834055e65ab507d3e39f8d8a8b683b7e83787a69e7b1'
  })
});

export function certifyToolchain(candidate,profile=FrozenToolchains.vite830){
  const required=['consumer','consumerVersion','rolldown','rolldownBinding','rolldownWasmSha256','lightningcss','lightningcssTarballSha256','lightningcssWasmSha256'];
